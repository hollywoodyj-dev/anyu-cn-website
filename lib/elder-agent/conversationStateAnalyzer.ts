...
function detectThread(text: string): EmotionalThread {
  ...
  if (
    /仔女|子女|儿子|女儿|孩子|家人|個女|个女|佢哋|你哋|掛住|挂住|想佢哋|返嚟|返来|回来吃饭|叫他们|叫佢哋|通电话|通電話|打电话|打電話|联系|聯絡|不在乎|唔在乎|不在乎我的感受|不理我|唔理我|不来看|都不来看|来看我|看手机|也很少理我|很少理我|不需要我|(他们|她們|她们).*空/.test(
      text,
    )
  ) {
  ...
  if (/没人|没有人|冇人|无人|无人理|孤单|孤單|孤独|寂寞|无聊|無聊|静|靜|冷清|闷|悶|空落落|空空地|空空的|找谁说|没人可说|冇人倾|冇人講|同邊個講|想有人陪|没人在家|就剩我一个|在意我/.test(text)) {
    return "loneliness";
  }
  return "unclear";
}
