    ...
    <div className="relative overflow-hidden rounded-3xl bg-[#F8F3EC] text-[#3C332C] md:rounded-[2rem]">
      ...
      <div className="relative z-10 px-1 pb-16 pt-4 md:px-2 md:pb-24 md:pt-6">
        ...
        <section className="mx-auto grid max-w-6xl items-center gap-12 pb-16 pt-4 lg:grid-cols-2 lg:gap-14 lg:pb-24 lg:pt-8">
          ...
          {/* Hero visual — 灯 + 整理卡 + 子女端（示意，非真实截图） */}
          <div className="relative mx-auto min-h-[480px] w-full max-w-[560px] lg:mx-0 lg:min-h-[520px]">
            ...
            <div className="absolute left-0 top-24 flex w-56 flex-col items-center rounded-[3rem] border border-white bg-white/80 py-10 shadow-2xl shadow-[#B08B6C]/20 backdrop-blur sm:left-4 sm:w-64 md:top-32">
              ...
              <div className="mt-8 text-lg font-medium text-[#4B4038]">安语灯</div>
              <p className="mt-3 max-w-[11rem] px-4 text-center text-sm leading-6 text-[#85766C]">
                “我今天有点想孩子。”
              </p>
              <div
                className="mt-7 h-16 w-16 rounded-full border-4 border-white bg-[#F5D7BE] shadow-inner"
                aria-hidden
              />
            </div>
            ...
            <div className="absolute bottom-4 right-0 w-[min(100%,18rem)] rounded-[2.4rem] bg-[#332B27] p-2.5 shadow-2xl shadow-[#4A3325]/30 sm:right-4 sm:w-72 md:bottom-12 md:right-8">
              <div className="min-h-[260px] rounded-[2rem] bg-[#FFF9F2] p-4 md:min-h-[300px] md:p-5">
                ...
                <svg
                  viewBox="0 0 200 48"
                  className="mt-3 w-full text-[#C49A7C]"
                  aria-hidden
                >
                  <polyline
                    fill="none"
                ...
                <Link
                  href="/cn/for-family"
                  className="mt-5 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#9D6A4D] py-3 text-sm text-white transition hover:bg-[#8a5d43] md:mt-6"
                >
        ...
        <section className="mx-auto max-w-6xl pb-16 md:pb-28" aria-labelledby="trust-band">
          <div className="grid items-center gap-10 rounded-[2.5rem] bg-[#3B312B] p-8 text-white shadow-2xl shadow-[#3B312B]/20 md:grid-cols-[1.2fr_0.8fr] md:p-12">
            <div>
              ...
              <h2 id="trust-band" className="mt-5 text-2xl font-semibold leading-tight md:text-3xl md:text-4xl">
                安语不会取代家人。
              </h2>
